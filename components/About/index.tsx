        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            <motion.div
              ...
              viewport={{ once: true }}
              className="animate_left relative mx-auto hidden sm:block sm:w-full"
            >
              <Image
              src="/images/about/about-flyer-light-01.jpeg"
              alt="About"
              ...
              />
              <Image
              src="/images/about/about-flyer-dark-01.jpeg"
              alt="About"
      ...
      {/* <section className="overflow-hidden pb-20 lg:pb-25 xl:pb-30">
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <Image
                src="/images/about/about-light-01.jpeg"
                alt="About"
